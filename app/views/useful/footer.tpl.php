...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script src="<?= $baseURI ?>/assets/js/jquery.slicknav.js"></script>
    <script src="<?= $baseURI ?>/assets/js/jquery.nice-select.min.js"></script>
    <script src="<?= $baseURI ?>/assets/js/mixitup.min.js"></script>
